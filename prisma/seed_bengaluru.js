...
async function main() {
    ...
    for (const hotel of bengaluruHotels) {
        // Use Unsplash images instead of example.com to ensure they load
        // I've replaced the example.com URLs in the array above with real Unsplash IDs
